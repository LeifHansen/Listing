...
- [ ] P1-07, MINUS create-on-unknown and the unshown terms (both done, see
      above): Settings still saves local preferences and remote eBay state in
      one action where the first can commit and the second fail, and loads
      still collapse "unavailable" into "empty".

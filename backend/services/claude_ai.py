...
REFINED_FIELDS = (
    ...
    # What the tag says it retailed for, read off the photos like the price
    # sticker beside it — the model's answer, and the anchor under what a
    # still-new item should list for.
    "retail_price",
